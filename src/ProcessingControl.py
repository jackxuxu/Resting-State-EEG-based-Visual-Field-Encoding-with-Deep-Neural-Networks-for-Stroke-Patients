...
np.savetxt('allcontrol_afterv6Power.csv', X1, delimiter=',')
np.save('allcontrol_afterv6Power', X1) 
np.savetxt('allcontrol_afterv6Mean.csv', X2, delimiter=',')
np.save('allcontrol_afterv6Mean', X2)
np.savetxt('allcontrol_afterv6StandardDeviation.csv', X3, delimiter=',')
np.save('allcontrol_afterv6StandardDeviation', X3) 
np.savetxt('allcontrol_afterv61stDifference.csv', X4, delimiter=',')
np.save('allcontrol_afterv61stDifference', X4) 
np.savetxt('allcontrol_afterv6Normalized1stDifference.csv', X5, delimiter=',')
np.save('allcontrol_afterv6Normalized1stDifference', X5) 
np.savetxt('allcontrol_afterv62stDifference.csv', X6, delimiter=',')
np.save('allcontrol_afterv62stDifference', X6) 
np.savetxt('allcontrol_afterv6Normalized2stDifference.csv', X7, delimiter=',')
np.save('allcontrol_afterv6Normalized2stDifference', X7) 
...
np.savetxt('allcontrol_afterv6respB.csv', percentControlb, delimiter=',')
np.save('allcontrol_afterv6respB', percentControlb) 
np.savetxt('allcontrol_afterv6respG.csv', percentControlg, delimiter=',')
np.save('allcontrol_afterv6respG', percentControlg) 
np.savetxt('allcontrol_afterv6respW.csv', percentControlw, delimiter=',')
np.save('allcontrol_afterv6respW', percentControlw) 
np.savetxt('allcontrol_afterv6resp.csv', percentControlbgw, delimiter=',')
np.save('allcontrol_afterv6resp', percentControlbgw) 
